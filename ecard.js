...
function saveContact() {
    const name = 'K M Abrar Ahsan';
    const organization = 'Roaming Tours & Travels';
    const title = 'Intern';
    const officePhone = '01768245475';
    const personalPhone = '01768245475';
    const email = 'abrar.roamingbd@gmail.com';
...
function openWhatsApp() {
    const whatsappNumber = '8801768245475';
